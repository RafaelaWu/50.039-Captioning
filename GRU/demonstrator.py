...
if __name__ == '__main__':
    ...
    parser.add_argument('--encoder_path', type=str, default='GRU128_encoder_epoch3.ckpt', help='path for trained encoder')
    parser.add_argument('--decoder_path', type=str, default='GRU128_decoder_epoch3.ckpt', help='path for trained decoder')
