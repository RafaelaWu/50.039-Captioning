...
def idx2word2list(vocab, idx_tensor):
    return_list = []

    for idx in idx_tensor:
        return_list.append(vocab.idx2word[int(idx)])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--encoder_path', type=str, default= home+ '/data2/models/encoder-3-3000.ckpt', help='path for trained encoder')
    parser.add_argument('--decoder_path', type=str, default= home+ '/data2/models/decoder-3-3000.ckpt', help='path for trained decoder')
    parser.add_argument('--vocab_path', type=str, default= home+ '/data2/vocab.pkl', help='path for vocabulary wrapper')
    parser.add_argument('--image_dir', type=str, default= home+ '/data2/resizedval2014', help='directory for resized images')
